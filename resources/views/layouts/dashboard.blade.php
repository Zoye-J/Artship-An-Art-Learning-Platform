...
<body class="bg-amber-50 text-amber-900 font-sans">
    ...
    <div class="flex min-h-screen">
        ...
        <!-- Sidebar -->
        <aside class="w-64 bg-amber-100 border-r border-amber-300 p-4">
            <h1 class="text-2xl font-bold mb-6">Artship</h1>
            ...
            <nav class="flex flex-col space-y-4">
                ...
                @if(auth()->check() && auth()->user()->role !== 'admin')
                    <a href="{{ route('wishlist.index') }}" class="block px-4 py-2 hover:bg-amber-100 rounded">
                        Wishlist
                    </a>
                @endif
            </nav>
